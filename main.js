...
function playRound(playerSelection, computerSelection) {
    ...
    else if (playerSelection == "paper" && computerSelection == "Rock") return "You Lose! Paper beats Rock";
    else if (playerSelection == "paper" && computerSelection == "Scissors") return "You Win! Paper beats Scissors";
